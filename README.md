...
> behavior may change before `1.0.0`. See [`RELEASE_POLICY.md`](RELEASE_POLICY.md).
...
[`RELEASE_CHANNELS.md`](RELEASE_CHANNELS.md) for the release policy.
...
[`SUPPORT_POLICY.md`](SUPPORT_POLICY.md) for compatibility, deprecation,
...
- [`Architecture.md`](Architecture.md) describes the core boundaries and workflow
  model.
- [`SUPPORT_POLICY.md`](SUPPORT_POLICY.md) describes supported environments and
